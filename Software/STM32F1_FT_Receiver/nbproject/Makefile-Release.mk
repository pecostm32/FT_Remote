...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/stm32f1_ft_receiver

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/stm32f1_ft_receiver: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/stm32f1_ft_receiver ${OBJECTFILES} ${LDLIBSOPTIONS} -T./stm32f103-64k.ld -nostdlib
...
${OBJECTDIR}/_ext/5c0/stm32f103_motor_control.o: ../stm32f103_motor_control.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/stm32f103_motor_control.o ../stm32f103_motor_control.c
...
${OBJECTDIR}/stm32f103_ft_receiver.o: stm32f103_ft_receiver.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stm32f103_ft_receiver.o stm32f103_ft_receiver.c
